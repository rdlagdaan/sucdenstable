...
export default function AccountsReceivableJournal() {
  ...
  const download = async () => {
    ...
    const url = `/accounts-receivable/report/${ticket}/download`;
    ...
    a.download =
      status.format === 'pdf'
        ? 'accounts_receivable_journal.pdf'
        : 'accounts_receivable_journal.xls';
    a.click();
  ...
  const viewPdf = () => {
    ...
    window.open(`/accounts-receivable/report/${ticket}/view`, '_blank', 'noopener');
  };
          ...
          <div className="bg-white rounded-xl shadow-xl w-full max-w-lg p-5">
            ...
            <div className="mt-4 flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <button
                  className={`px-3 py-2 rounded ${
                    status?.status === 'done' && status?.format === 'pdf'
